...
const formationLayouts: Record<string, number[][]> = {
  "4-4-2": [[50], [20, 40, 60, 80], [20, 40, 60, 80], [30, 70]],
  "4-3-3": [[50], [20, 40, 60, 80], [25, 50, 75], [20, 50, 80]],
  "3-5-2": [[50], [25, 50, 75], [15, 30, 50, 70, 85], [35, 65]],
  "4-2-3-1": [[50], [20, 40, 60, 80], [35, 65], [20, 50, 80], [50]],
  "3-4-3": [[50], [25, 50, 75], [20, 40, 60, 80], [20, 50, 80]],
};

export function FormationView({ formation, clubName }: FormationViewProps) {
  const layout =
    formationLayouts[formation.formation] || formationLayouts["4-4-2"];
  ...
  return (
    <Card className="p-6 bg-neutral-800 border-neutral-700">
      ...
      <div
        className="bg-gradient-to-b from-green-900/20 to-green-800/20 rounded-lg p-8 relative"
