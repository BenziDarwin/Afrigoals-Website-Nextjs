    ...
    const mockComments: Comment[] = [
      {
        ...
        comment_text:
          "Great match! Lagos Lions played exceptionally well. Samuel Adeola is truly a star player.",
      ...
      },
      {
        ...
        comment_text:
          "The atmosphere at the National Stadium was electric! What a game to witness.",
      ...
      },
      {
        ...
        comment_text:
          "Ibrahim Musa's goal was absolutely stunning. Goal of the season contender!",
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {comments.map((comment) => (
          <Card
            key={comment.id}
            className="bg-white border border-gray-200 shadow-sm hover:shadow transition-shadow"
          >
            <div className="p-6">
