...
export default function ClubManagerDashboard() {
  ...
  const loadStats = async () => {
    setTimeout(() => {
      ...
      const wins = clubMatches.filter(m =>
  ...
  const statCards = [
    { title: 'Squad Players', value: stats.players, icon: Users, color: 'text-blue-500' },
    { title: 'Matches Played', value: stats.matches, icon: CalendarDays, color: 'text-green-500' },
    { title: 'Match Videos', value: stats.videos, icon: Video, color: 'text-purple-500' },
    { title: 'Wins', value: stats.wins, icon: TrendingUp, color: 'text-orange-500' },
  ];
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Club Manager Dashboard</h1>
          <p className="text-neutral-400">Manage your team, players, and match preparations</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="p-6 bg-neutral-800 border-neutral-700">
            ...
            <div className="space-y-3">
              {[...Array(5)].map((_, i) => (
                <div key={i} className="flex items-center justify-between p-3 bg-neutral-700 rounded-lg">
              ...
              {[...Array(3)].map((_, i) => (
                <div key={i} className="p-4 bg-neutral-700 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-neutral-400 text-sm">Match {i + 1}</span>
