export const mockPlayersEnhanced = [
  // Lagos Lions
  { id: '1', club_id: '1', name: 'Samuel Adeola', jersey_number: 10, position: 'Forward', photo_url: undefined, date_of_birth: '1995-03-15', nationality: 'Nigeria', stats: { goals: 15, assists: 8, matches: 20, minutes: 1800, yellow_cards: 2, red_cards: 0, shots: 45, passes: 320, tackles: 15 } },
  { id: '2', club_id: '1', name: 'Emmanuel Okonkwo', jersey_number: 7, position: 'Midfielder', photo_url: undefined, date_of_birth: '1996-07-22', nationality: 'Nigeria', stats: { goals: 5, assists: 12, matches: 20, minutes: 1750, yellow_cards: 3, red_cards: 0, shots: 25, passes: 580, tackles: 45 } },
  { id: '3', club_id: '1', name: 'Chidi Nwosu', jersey_number: 1, position: 'Goalkeeper', photo_url: undefined, date_of_birth: '1993-05-10', nationality: 'Nigeria', stats: { goals: 0, assists: 0, matches: 20, minutes: 1800, yellow_cards: 1, red_cards: 0, shots: 0, passes: 120, tackles: 0, saves: 65, clean_sheets: 8 } },
  { id: '4', club_id: '1', name: 'Tunde Bakare', jersey_number: 4, position: 'Defender', photo_url: undefined, date_of_birth: '1994-08-20', nationality: 'Nigeria', stats: { goals: 2, assists: 3, matches: 19, minutes: 1710, yellow_cards: 5, red_cards: 0, shots: 8, passes: 450, tackles: 62 } },
  { id: '5', club_id: '1', name: 'Ademola Balogun', jersey_number: 5, position: 'Defender', photo_url: undefined, date_of_birth: '1996-01-12', nationality: 'Nigeria', stats: { goals: 1, assists: 2, matches: 18, minutes: 1620, yellow_cards: 4, red_cards: 0, shots: 5, passes: 420, tackles: 55 } },
  { id: '6', club_id: '1', name: 'Oluwaseun Adeyemi', jersey_number: 8, position: 'Midfielder', photo_url: undefined, date_of_birth: '1997-03-25', nationality: 'Nigeria', stats: { goals: 4, assists: 7, matches: 19, minutes: 1650, yellow_cards: 2, red_cards: 0, shots: 22, passes: 510, tackles: 38 } },
  { id: '7', club_id: '1', name: 'Ibrahim Musa', jersey_number: 11, position: 'Forward', photo_url: undefined, date_of_birth: '1998-06-14', nationality: 'Nigeria', stats: { goals: 9, assists: 5, matches: 18, minutes: 1440, yellow_cards: 1, red_cards: 0, shots: 35, passes: 280, tackles: 12 } },
  
  // Nairobi Warriors
  { id: '8', club_id: '2', name: 'David Kimani', jersey_number: 9, position: 'Forward', photo_url: undefined, date_of_birth: '1994-11-08', nationality: 'Kenya', stats: { goals: 12, assists: 6, matches: 19, minutes: 1710, yellow_cards: 2, red_cards: 0, shots: 40, passes: 295, tackles: 18 } },
  { id: '9', club_id: '2', name: 'Joseph Wanjiru', jersey_number: 5, position: 'Defender', photo_url: undefined, date_of_birth: '1997-02-19', nationality: 'Kenya', stats: { goals: 1, assists: 1, matches: 20, minutes: 1800, yellow_cards: 6, red_cards: 1, shots: 4, passes: 485, tackles: 70 } },
  { id: '10', club_id: '2', name: 'Michael Otieno', jersey_number: 1, position: 'Goalkeeper', photo_url: undefined, date_of_birth: '1992-09-15', nationality: 'Kenya', stats: { goals: 0, assists: 0, matches: 20, minutes: 1800, yellow_cards: 0, red_cards: 0, shots: 0, passes: 105, tackles: 0, saves: 72, clean_sheets: 6 } },
  { id: '11', club_id: '2', name: 'Patrick Odhiambo', jersey_number: 6, position: 'Midfielder', photo_url: undefined, date_of_birth: '1995-07-22', nationality: 'Kenya', stats: { goals: 3, assists: 9, matches: 19, minutes: 1665, yellow_cards: 3, red_cards: 0, shots: 18, passes: 545, tackles: 42 } },
  { id: '12', club_id: '2', name: 'Brian Mutua', jersey_number: 10, position: 'Midfielder', photo_url: undefined, date_of_birth: '1996-04-18', nationality: 'Kenya', stats: { goals: 7, assists: 11, matches: 20, minutes: 1750, yellow_cards: 2, red_cards: 0, shots: 28, passes: 620, tackles: 35 } },
];
...
export const mockFormations = [
  // Match 1: Lagos Lions (4-3-3)
  {
    ...
    formation: '4-3-3',
    lineup: [
      { player_id: '3', name: 'Chidi Nwosu', jersey_number: 1, position: 'GK', x: 50, y: 5 },
      { player_id: '4', name: 'Tunde Bakare', jersey_number: 4, position: 'LB', x: 20, y: 20 },
      { player_id: '5', name: 'Ademola Balogun', jersey_number: 5, position: 'CB', x: 40, y: 20 },
      { player_id: '21', name: 'Akin Lawal', jersey_number: 3, position: 'CB', x: 60, y: 20 },
      { player_id: '22', name: 'Femi Olatunji', jersey_number: 2, position: 'RB', x: 80, y: 20 },
      { player_id: '2', name: 'Emmanuel Okonkwo', jersey_number: 7, position: 'CM', x: 35, y: 45 },
      { player_id: '6', name: 'Oluwaseun Adeyemi', jersey_number: 8, position: 'CM', x: 50, y: 50 },
      { player_id: '23', name: 'Kunle Ajayi', jersey_number: 6, position: 'CM', x: 65, y: 45 },
      { player_id: '7', name: 'Ibrahim Musa', jersey_number: 11, position: 'LW', x: 20, y: 75 },
      { player_id: '1', name: 'Samuel Adeola', jersey_number: 10, position: 'ST', x: 50, y: 80 },
      { player_id: '24', name: 'Victor Nnamdi', jersey_number: 9, position: 'RW', x: 80, y: 75 }
    ]
  },
  // Match 1: Nairobi Warriors (4-4-2)
  {
    ...
    formation: '4-4-2',
    lineup: [
      { player_id: '10', name: 'Michael Otieno', jersey_number: 1, position: 'GK', x: 50, y: 5 },
      { player_id: '25', name: 'James Karanja', jersey_number: 3, position: 'LB', x: 20, y: 20 },
      { player_id: '9', name: 'Joseph Wanjiru', jersey_number: 5, position: 'CB', x: 40, y: 20 },
      { player_id: '26', name: 'Dennis Ouma', jersey_number: 4, position: 'CB', x: 60, y: 20 },
      { player_id: '27', name: 'Collins Mwangi', jersey_number: 2, position: 'RB', x: 80, y: 20 },
      { player_id: '28', name: 'Kevin Onyango', jersey_number: 7, position: 'LM', x: 20, y: 50 },
      { player_id: '11', name: 'Patrick Odhiambo', jersey_number: 6, position: 'CM', x: 40, y: 45 },
      { player_id: '12', name: 'Brian Mutua', jersey_number: 10, position: 'CM', x: 60, y: 45 },
      { player_id: '29', name: 'Victor Wafula', jersey_number: 11, position: 'RM', x: 80, y: 50 },
      { player_id: '8', name: 'David Kimani', jersey_number: 9, position: 'ST', x: 40, y: 75 },
      { player_id: '30', name: 'Eric Omondi', jersey_number: 14, position: 'ST', x: 60, y: 75 }
    ]
  }
];
...
The match statistics tell the story of Lagos Lions' dominance, with 58% possession, 15 shots on target, and a passing accuracy of 87%. Samuel Adeola was named Man of the Match for his tireless running and clinical finishing.
    `,
    excerpt: 'The Lagos Lions defeated Nairobi Warriors 2-1 in an exciting encounter at the National Stadium, with goals from Samuel Adeola and Ibrahim Musa securing all three points.',
    featured_image: 'https://images.pexels.com/photos/274422/pexels-photo-274422.jpeg?auto=compress&cs=tinysrgb&w=1200',
    ...
    tags: ['Match Report', 'Lagos Lions', 'Nairobi Warriors', 'African Premier League'],
...
For Adeola, the goal is clear: "I want to win trophies with this club and continue improving as a player. We have the quality to achieve great things, and I'm excited about what the future holds."
    `,
    excerpt: 'Star forward Samuel Adeola has signed a new three-year deal with Lagos Lions, committing his future to the African Premier League club until 2027.',
    ...
    tags: ['Transfer News', 'Samuel Adeola', 'Lagos Lions', 'Contract Extension'],
