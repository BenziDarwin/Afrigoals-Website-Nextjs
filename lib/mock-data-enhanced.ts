    ...
    events: [
      {
        ...
        type: "kickoff",
        team: "Lagos Lions",
        description: "Match kicks off at the National Stadium",
        player: null,
      },
      {
        minute: 8,
        ...
        team: "Lagos Lions",
        description:
          "GOAL! Samuel Adeola opens the scoring with a brilliant strike from outside the box!",
        player: "Samuel Adeola",
        jersey_number: 10,
      },
      {
        minute: 12,
        ...
        description: "Yellow card for Joseph Wanjiru for a late tackle",
        player: "Joseph Wanjiru",
        jersey_number: 5,
      },
      {
        minute: 23,
        ...
        team: "Nairobi Warriors",
        description:
          "Great save! Chidi Nwosu denies David Kimani from close range",
        player: "David Kimani",
        jersey_number: 9,
      },
      {
        ...
        team: "Lagos Lions",
        description:
          "GOAL! Ibrahim Musa doubles the lead with a header from a corner kick!",
        player: "Ibrahim Musa",
        jersey_number: 11,
      },
      {
        ...
        type: "substitution",
        team: "Nairobi Warriors",
        description: "Substitution: Peter Njoroge replaces James Karanja",
        player: "Peter Njoroge",
        jersey_number: 14,
      },
      {
        minute: 45,
        type: "halftime",
        team: null,
        description: "Half-time: Lagos Lions 2-0 Nairobi Warriors",
        player: null,
      },
      {
        minute: 46,
      ...
      },
      {
        ...
        team: "Nairobi Warriors",
        description:
          "GOAL! David Kimani pulls one back for the Warriors with a powerful header!",
        player: "David Kimani",
        jersey_number: 9,
      },
      {
        ...
        type: "chance",
        team: "Lagos Lions",
        description: "Close! Samuel Adeola hits the post after a mazy run",
        player: "Samuel Adeola",
        jersey_number: 10,
      },
      {
        ...
        type: "yellow_card",
        team: "Lagos Lions",
        description: "Yellow card for Tunde Bakare for time-wasting",
        player: "Tunde Bakare",
        jersey_number: 4,
      },
      {
        ...
        type: "substitution",
        team: "Lagos Lions",
        description: "Substitution: Victor Nnamdi comes on for Ibrahim Musa",
        player: "Victor Nnamdi",
        jersey_number: 9,
      },
      {
        minute: 82,
        ...
        team: "Nairobi Warriors",
        description:
          "Crucial block! Ademola Balogun denies Brian Mutua from scoring",
        player: "Brian Mutua",
        jersey_number: 10,
      },
      {
        ...
        type: "info",
        team: null,
        description: "4 minutes of added time",
        player: null,
      },
      {
        minute: 94,
        type: "fulltime",
        team: null,
        description: "Full-time: Lagos Lions 2-1 Nairobi Warriors",
        player: null,
      },
    ],
  },
    ...
    events: [
      {
        ...
        type: "kickoff",
        team: "Cairo Giants",
        description: "Match underway at Cairo Stadium",
        player: null,
      },
      {
        minute: 15,
        type: "goal",
        team: "Cape Town Spurs",
        description: "GOAL! Early strike from Cape Town Spurs!",
      ...
      },
      {
        ...
        team: "Cairo Giants",
        description:
          "GOAL! Cairo Giants equalize with a well-worked team goal!",
      ...
      },
      {
        ...
        type: "halftime",
        team: null,
        description: "Half-time: Cairo Giants 1-1 Cape Town Spurs",
        player: null,
      },
      {
        minute: 46,
      ...
      },
      {
        ...
        type: "substitution",
        team: "Cairo Giants",
        description: "Fresh legs for Cairo Giants",
        player: "Omar Farouk",
        jersey_number: 18,
      },
      {
        ...
        type: "goal",
        team: "Cairo Giants",
        description: "GOAL! Late winner for Cairo Giants!",
        player: "Mohamed Salah",
        jersey_number: 10,
      },
      {
        ...
        type: "fulltime",
        team: null,
        description: "Full-time: Cairo Giants 2-1 Cape Town Spurs",
        player: null,
      },
    ],
  },
  {
    ...
    events: [
      ...
      },
      {
        ...
        type: "goal",
        team: "Accra Hearts",
        description: "GOAL! Accra Hearts take an early lead!",
        player: "Kwame Mensah",
        jersey_number: 11,
      },
      {
      ...
      },
      {
        ...
        type: "chance",
        team: "Johannesburg Stars",
        description: "Great opportunity! Shot goes just wide",
        player: "David Jones",
        jersey_number: 9,
      },
      {
        ...
        type: "goal",
        team: "Johannesburg Stars",
        description: "GOAL! Johannesburg Stars equalize before the break!",
        player: "David Jones",
        jersey_number: 9,
      },
      {
        ...
        type: "halftime",
        team: null,
        description: "Half-time: Accra Hearts 1-1 Johannesburg Stars",
        player: null,
      },
      {
        minute: 46,
      ...
      },
      {
        ...
        type: "chance",
        team: "Accra Hearts",
        description: "Close call! Goalkeeper makes a stunning save",
        player: "Kwame Mensah",
        jersey_number: 11,
      },
      {
        ...
        team: null,
        description:
          "Both teams pushing for a winner in this thrilling encounter",
        player: null,
      },
    ],
  },
